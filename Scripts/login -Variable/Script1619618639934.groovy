...
WebUI.doubleClick(findTestObject('Object Repository/Page_Login Admin/input_Email_email'))

WebUI.setText(findTestObject('Object Repository/Page_Login Admin/input_Email_email'), username)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login Admin/input_Password_password'), passwd)
